    ...
    <div class="overlay"></div>
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span class="mr-2"><a href="<?= base_url('blog'); ?>">Blog</a></span> <span>Blog Single</span></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <p>
              <img src="<?= base_url('assets/'); ?>images/image_7.jpg" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="<?= base_url('assets/'); ?>images/image_8.jpg" alt="" class="img-fluid">
            </p>
